...
<form class="flex flex-row justify-center w-full" method="POST" action={loginAction} use:enhance>
    <input class="input mr-1" type="password" name="adminKey" placeholder="Admin Key">
